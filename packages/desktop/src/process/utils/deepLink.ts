...
export const PROTOCOL_SCHEME = 'threetwoa';

/**
 * Parse an threetwoa:// URL into action and params.
 * Supports two formats:
 *   1. threetwoa://add-provider?base_url=xxx&api_key=xxx
 *   2. threetwoa://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
