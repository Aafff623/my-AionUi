...
for f in threetwoa-1.0.0-win-x64.exe threetwoa-1.0.0-win-arm64.exe threetwoa-1.0.0-mac-x64.dmg threetwoa-1.0.0-mac-arm64.dmg threetwoa-1.0.0.deb threetwoa-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
